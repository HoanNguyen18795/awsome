...
@RestController
@RequestMapping("/api/awsome-kafka")
public class AwsomeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AwsomeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AwsomeKafkaResource(KafkaProperties kafkaProperties) {
